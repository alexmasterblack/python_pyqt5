...
class MyWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        self.pop.clicked.connect(self.delete)
...
class Del(QWidget):
    def __init__(self):
        ...
        self.oh_no.clicked.connect(self.answer_no)
        self.oh_yes.clicked.connect(self.answer_yes)
    ...
    def answer_yes(self):
        ...
        for i in range(len(indexes)-1, -1, -1):
            ...
            main.cur.execute(f'DELETE from Films WHERE id = \'{main.all_result[indexes[i].row()][0]}\'')
